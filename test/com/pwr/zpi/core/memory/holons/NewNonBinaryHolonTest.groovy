...
//                im1, new LatestSelector(), testDk1.getGroundingSetsMap());
    ...
    void testUpdate() {
        ...
        testObj = new NonBinaryHolon(testDk1, contextualisation)
        testObj.update()
        ...
        testObj = new NonBinaryHolon(testDk2, contextualisation)
        testObj.update()
        ...
        testObj = new NonBinaryHolon(testDk3, contextualisation)
        testObj.update()
        ...
        testObj = new NonBinaryHolon(testDk4, contextualisation)
        testObj.update()
